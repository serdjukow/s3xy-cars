...
document.addEventListener('DOMContentLoaded', () => {
	...
	// Accessories Slider
	let accessoriesSlider = new Swiper(".accessories-slider", {
		loop: true,
		spaceBetween: 12,
		slidesPerView: 4,
		freeMode: true,
	...
	let accessoriesSlider2 = new Swiper(".accessories-slider-2", {
		loop: true,
		spaceBetween: 10,
		navigation: {
			nextEl: ".swiper-button-next",
	...
	if (buttons.length > 0) {
		...
		function onButtonClick(e) {
			...
			if (buttonLink.dataset.goto && document.querySelector(buttonLink.dataset.goto)) {
				...
				const gotoBlockValue = gotoBlock.getBoundingClientRect().top + pageYOffset - 95
				window.scrollTo({
					top: gotoBlockValue,
					behavior: "smooth"
				})
